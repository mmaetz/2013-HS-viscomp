...
\makechapterstyle{test}{
	...
	\renewcommand{\afterchaptertitle}{\par\nobreak\vspace{-0.5em}\rule{\columnwidth}{0.2em}\colorlet{rulecolor}{black}\vskip\afterchapskip}
}
...
\setsecheadstyle{\colorhrule{sectionlinecolor}{1ex}{\columnwidth}\vspace{-0.25ex}\normalsize\bfseries}
\setsubsecheadstyle{\colorhrule{subsectionlinecolor}{0.5ex}{\columnwidth}\vspace{-0.125ex}\color{subsectionlinecolor}\normalsize\bfseries}
\setparaheadstyle{\small\bfseries}
%\setsubsubsecheadstyle{\normalsize\scshape\raggedright}
\setbeforesecskip{-1.2ex plus -.25ex minus -.1ex}
\setaftersecskip{0.25ex plus .05ex}
\setbeforesubsecskip{-0.5ex plus -.25ex minus -.1ex}
